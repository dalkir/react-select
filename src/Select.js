	...
	render () {
		...
		return (
			<div ref="wrapper" className={selectClass}>
				...
				<div className={'Select-control ' + this.props.controlClassName} ref="control" onKeyDown={this.handleKeyDown} onMouseDown={this.handleMouseDown} onTouchEnd={this.handleMouseDown}>
					{value}
					{input}
					{loading}
					{clear}
